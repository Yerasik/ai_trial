...
class Loss_CategoricalCrossentropy (Loss) :
    ...
    # Backward pass
    def backward (self, avalues, y_true):
        # Number of samples
        samples = len(dvalues)
...
for epoch in range(10001):
    ...
    if not epoch % 100:
        print(f'epoch: {epoch}, ' + f'acc: {accuracy: 3f}, ' + f'loss: {loss: .3f},'+ f'reg_loss: {regularization_loss: .3f} ' +f'lr: {optimizer.current_learning_rate} ')
    # Backward pass
